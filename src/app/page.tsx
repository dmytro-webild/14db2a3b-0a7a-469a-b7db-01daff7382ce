...
export default function LandingPage() {
  ...
  <div id="home" data-section="home">
      ...
      slides={[
        ...
        {
          imageSrc: "http://img.b2bpic.net/free-photo/well-known-networking-icons-near-social-network-text-wooden-table_23-2147841378.jpg",
          imageAlt: "Global social media network connections",
          videoAriaLabel: "Abstract representation of global social media reach",
        },
      ]}
      autoplayDelay={4000}
      showDimOverlay={true}
      ...
      bulletPoints={[
        {
          ...
          description: "Crafting narratives that resonate and convert, tailored to your unique brand.",
        },
        {
          title: "Targeted Campaigns",
          description: "Precision-driven ad campaigns that reach your ideal audience with maximum impact.",
        },
        {
          title: "Performance Analytics",
          description: "Leveraging insights to optimize strategies and ensure continuous growth.",
        },
      ]}
  ...
  <div id="services" data-section="services">
      ...
      features={[
        {
          title: "Global Reach",
          description: "Expand your brand's influence to audiences worldwide with expertly localized campaigns.",
          bentoComponent: "globe",
          imageSrc: "http://img.b2bpic.net/free-photo/people-with-social-media-concept_53876-20696.jpg",
      ...
      metrics={[
        {
          id: "m1",
          value: "200%+",
          description: "Average follower growth for our clients in the first 6 months.",
        },
        {
          id: "m2",
          value: "3x",
          description: "Increase in engagement rates across managed social profiles.",
        },
        {
          id: "m3",
          value: "35%",
          description: "Reduction in cost-per-acquisition for paid social campaigns.",
        },
        {
          id: "m4",
          value: "95%",
      ...
      testimonials={[
        {
          ...
          name: "Sarah J.",
          handle: "@TechInnovate",
          testimonial: "Social Spark Agency transformed our online presence. Their creative campaigns and data insights led to incredible growth. Truly exceptional!",
          rating: 5,
          imageSrc: "http://img.b2bpic.net/free-photo/portrait-modern-businesswoman-standing_23-2148204492.jpg",
          imageAlt: "Sarah J. from Tech Innovate",
        },
        {
          id: "2",
          name: "Michael C.",
          handle: "@FashionForward",
          testimonial: "The team at Social Spark is top-notch. They understood our brand vision perfectly and delivered a social strategy that felt authentic and drove sales.",
          rating: 5,
          imageSrc: "http://img.b2bpic.net/free-photo/man-cafe_1098-13701.jpg",
          imageAlt: "Michael C. from Fashion Forward",
        },
        {
          id: "3",
          name: "Emily R.",
          handle: "@GourmetBites",
          testimonial: "Our restaurant's social media has never been better. Social Spark brought fresh ideas and managed everything seamlessly, attracting more customers than ever.",
          rating: 5,
          imageSrc: "http://img.b2bpic.net/free-photo/happy-man-with-eyeglasses-smiling-office_329181-14553.jpg",
          imageAlt: "Emily R. from Gourmet Bites",
        },
        {
          id: "4",
          name: "David K.",
          handle: "@FitnessPro",
          testimonial: "Remarkable results! Our engagement rates soared, and our community is more active. Social Spark Agency is a true partner in growth.",
          rating: 5,
          imageSrc: "http://img.b2bpic.net/free-photo/pleased-cheerful-young-man-chats-online-with-friends-from-abroad-sits-front-laptop-computer-connected-4g-internet-coffee-shop-wears-optical-glasses-good-vision-likes-his-job_273609-29248.jpg",
          imageAlt: "David K. from Fitness Pro",
        },
        {
          id: "5",
          name: "Jessica L.",
          handle: "@SecureFinance",
          testimonial: "Professional, strategic, and always responsive. Social Spark helped us navigate complex digital landscapes and build trust with our audience.",
          rating: 5,
          imageSrc: "http://img.b2bpic.net/free-photo/people-looking-photo_23-2148503496.jpg",
          imageAlt: "Jessica L. from Secure Finance",
        },
      ]}
      showRating={true}
          ...
          members: [
            {
              ...
              detail: "Over 15 years experience in digital marketing, leading award-winning campaigns.",
              ...
              imageAlt: "Alex Chen, Founder & CEO",
            },
            {
              id: "member-2",
              title: "Maria Rodriguez",
              subtitle: "Head of Creative",
              detail: "A visionary content strategist with a passion for captivating visual storytelling.",
              imageSrc: "http://img.b2bpic.net/free-photo/social-media-star-uses-professional-gear-film-vlog-intro_482257-114505.jpg",
              imageAlt: "Maria Rodriguez, Head of Creative",
            },
            {
              id: "member-3",
              title: "Ben Carter",
              subtitle: "Director of Strategy",
              detail: "Specializing in data-driven growth and performance marketing optimization.",
              imageSrc: "http://img.b2bpic.net/free-photo/young-woman-organizing-live-shop_23-2149947439.jpg",
              imageAlt: "Ben Carter, Director of Strategy",
            },
            {
              id: "member-4",
              title: "Sophie Lee",
              subtitle: "Community Lead",
              detail: "Building vibrant online communities and fostering authentic brand connections.",
      ...
      faqs={[
        {
          ...
          content: "We cover all major platforms including Facebook, Instagram, X (Twitter), LinkedIn, Pinterest, TikTok, and YouTube, tailoring strategies to where your audience is most active.",
        },
        {
          id: "faq-2",
          title: "How do you measure success?",
          content: "We track key metrics such as follower growth, engagement rates, website traffic, lead generation, and conversion rates, providing detailed monthly reports.",
        },
        {
          id: "faq-3",
          title: "Can you create content for our brand?",
          content: "Absolutely! Our in-house creative team specializes in producing high-quality visuals, videos, and compelling copy that aligns with your brand's voice and goals.",
        },
        {
          id: "faq-4",
          title: "What is your pricing model?",
          content: "Our pricing is customized based on your specific needs, goals, and the scope of services required. We offer various packages and can create a bespoke proposal after a consultation.",
        },
        {
          id: "faq-5",
          title: "How long does it take to see results?",
          content: "While results vary depending on the campaign and industry, clients typically see noticeable improvements in engagement and reach within 3-6 months. Long-term consistency drives the best outcomes.",
        },
      ]}
      ...
      buttons={[
        {
          ...
          href: "mailto:info@socialspark.com",
        },
        {
          text: "Call Us",
          href: "tel:+1234567890",
      ...
      columns={[
        ...
        },
        {
          ...
          items: [
            ...
            {
              label: "LinkedIn",
              href: "https://linkedin.com/company/socialsparkagency",
            },
            {
              label: "Instagram",
              href: "https://instagram.com/socialsparkagency",
            },
            {
              label: "X (Twitter)",
              href: "https://twitter.com/socialsparkagency",
            },
          ],
        },
      ]}
